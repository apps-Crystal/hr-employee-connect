  ...
  return (
    <div className="space-y">
      <div className="stat-grid">
        ...
        <div className="glass stat-card hover-card" style={{ cursor: 'pointer', border: activeFilter === 'Open' ? '1px solid var(--blue-400)' : '' }} onClick={() => setActiveFilter(activeFilter === 'Open' ? 'Needs Attention' : 'Open')}><p className="stat-value" style={{ color: 'var(--blue-400)' }}>{issues.filter(i => i.Status === 'Open').length}</p><p className="stat-label">⏳ Open</p></div>
